...
| Rol | ¿Para quién está pensado? | ¿Qué puede hacer? |
|---|---|---|
...
4. Si los datos son correctos, se abrirá el menú principal con sus opciones habilitadas.

Si aparece un mensaje de error:
- Revise que no haya espacios adicionales.
...
- Un **Administrador** visualizará todas las opciones del menú.
- Un **Vendedor** verá únicamente las funciones necesarias para su trabajo diario.

Si intenta entrar a una opción no permitida, el sistema bloqueará el acceso.
...
|---|---|---|
| “Usuario o contraseña incorrectos” | Datos mal escritos | Escriba nuevamente sus credenciales y verifique mayúsculas/minúsculas |
| “No se puede conectar al sistema” | El servicio o la red no está disponible | Cierre y abra la aplicación; si persiste, avise al área de soporte |
| No aparecen productos al vender | Catálogo sin stock o sin actualización | Actualice la búsqueda y valide con el administrador el estado del producto |
...
3. Seleccione **Generar respaldo**.
4. Elija la carpeta donde guardará el archivo.
5. Confirme y valide el mensaje de respaldo exitoso.
...
3. Seleccione el archivo de respaldo previamente generado.
4. Confirme la restauración.
5. Verifique que el sistema abra con normalidad y que los datos estén visibles.

**Importante:** Antes de restaurar, genere un respaldo actual para evitar pérdida de información.
...
El uso constante de esta guía mejora la operación diaria, reduce errores y facilita la continuidad del trabajo. Como mejora futura, se recomienda incorporar más capturas de pantalla y una sección de preguntas frecuentes para acelerar el aprendizaje de nuevos usuarios.

Agradecemos a todas las personas que participaron en el desarrollo del sistema y en la preparación de esta documentación.
